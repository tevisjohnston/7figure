      ...
      <Tailwind>
        <Body className="bg-[#f6f9fc] font-sans">
          <Container className="bg-white mx-auto pt-5 pb-12 mb-16 max-w-[700px]">
            ...
            <Text className="text-slate-700 text-base leading-[26px] my-4 px-10">
              This blueprint contains the exact system used by 7 figure affiliate marketers to generate consistent income.
            </Text>
            ...
            <Section className="px-10">
              <Text className="text-slate-700 text-sm leading-7 my-2">
                <strong>✓ The 4-steps to create a powerful system that converts traffic into revenue</strong>
              </Text>
              <Text className="text-slate-700 text-sm leading-7 my-2">
