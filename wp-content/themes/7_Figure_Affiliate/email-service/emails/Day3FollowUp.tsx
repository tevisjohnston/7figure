      ...
      <Tailwind>
        <Body className="bg-[#f6f9fc] font-sans">
          <Container className="bg-white mx-auto pt-5 pb-12 mb-16 max-w-[600px]">
            <Heading className="text-slate-900 text-lg font-bold my-10 px-10">
            ...
            <Text className="text-slate-900 text-base leading-7 my-6 py-5 px-10 bg-amber-100 border-l-4 border-amber-500">
            ...
            <Section className="px-10">
              ...
              <Text className="text-slate-700 text-base leading-7 my-4">
                ...
                <br />
                Log into your WarriorPlus account and check the <a href="https://warriorplus.com/affiliate/offers">offers page</a> for conversion rates. I only promote products converting at 3%+ minimum.
              </Text>
              <Text className="text-slate-700 text-base leading-7 my-4">
            ...
            <Text className="text-slate-700 text-base leading-[26px] my-4 px-10">
              ...
              generating consistent income monthly on autopilot.
            </Text>
            ...
            <EmailFooter
              ...
              footerNote="You're receiving this because you subscribed @ 7figure.affiliatemarketconnect.com"
            />
          </Container>
        </Body>
      </Tailwind>
