...
- Follow WordPress theme best practices at all times.
- Do NOT introduce new plugins, frameworks, or build systems unless explicitly instructed.
- Do NOT rename, merge, or delete existing templates unless explicitly instructed.
- Use existing Tailwind setup or styles.css for CSS variables; do not add new CSS frameworks.
- Keep PHP logic minimal inside templates; prefer existing patterns.
- When unsure, ASK before implementing.
- Output file changes one file at a time unless instructed otherwise.
