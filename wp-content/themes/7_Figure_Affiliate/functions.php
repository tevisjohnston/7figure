...
function Theme_7_Figure_Affiliate_wp_enqueue_styles() {
    ...
    wp_enqueue_style('tailwindcss', get_template_directory_uri() . '/assets/css/src/output.css');
}
...
function Theme_7_Figure_Affiliate_wp_enqueue_scripts() {
    wp_enqueue_script('theme-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.0.0', true);
    
    wp_localize_script('theme-main', 'themeData', array(
        'apiUrl' => rest_url('7figure/v1/lead-magnet-subscribe')
    ));
}
